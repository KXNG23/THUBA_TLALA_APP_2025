import { GoogleSearchIntegration } from "@/components/google-search-integration"
      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link href="/hd-stock-search" className="flex items-center space-x-2 text-green-600 hover:text-green-700">
              <ArrowLeft className="h-5 w-5" />
              <span>Back to HD Search</span>
            </Link>
