...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Responsive Header */}
      <ResponsiveHeader currentPage="contact" />

      {/* Hero Section */}
      <section className="py-12 md:py-16 bg-gradient-to-r from-green-600 to-green-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Get In Touch, MBUMBA!</h1>
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12">
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-green-800 text-lg md:text-xl">Call Us</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4 text-sm md:text-base">Speak directly with our team</p>
                <p className="text-xl md:text-2xl font-bold text-green-600 mb-4">063 984 4453</p>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow border-2 border-green-200">
              <CardHeader>
                ...
                <CardTitle className="text-green-800 text-lg md:text-xl">WhatsApp Chat</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4 text-sm md:text-base">Quick and easy messaging</p>
                <p className="text-xl md:text-2xl font-bold text-green-600 mb-4">063 984 4453</p>
                <a
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex justify-center mb-4">
                  <div className="bg-orange-100 p-3 md:p-4 rounded-full">
                    <Mail className="h-6 w-6 md:h-8 md:w-8 text-orange-600" />
                  </div>
                </div>
                <CardTitle className="text-green-800 text-lg md:text-xl">Email Us</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4 text-sm md:text-base">Send us a detailed message</p>
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-xl md:text-2xl text-green-800">Send Us a Message</CardTitle>
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg md:text-xl text-green-800 flex items-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
            <Card>
              <CardContent className="p-4 md:p-6">
                <h3 className="font-semibold text-green-800 mb-2 text-sm md:text-base">How do I join a Stockvel?</h3>
                <p className="text-gray-600 text-sm md:text-base">
            ...
            <Card>
              <CardContent className="p-4 md:p-6">
                <h3 className="font-semibold text-green-800 mb-2 text-sm md:text-base">How much can I save?</h3>
                <p className="text-gray-600 text-sm md:text-base">
            ...
            <Card>
              <CardContent className="p-4 md:p-6">
                <h3 className="font-semibold text-green-800 mb-2 text-sm md:text-base">When do deliveries happen?</h3>
                <p className="text-gray-600 text-sm md:text-base">
