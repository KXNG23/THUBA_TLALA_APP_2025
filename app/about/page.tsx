      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-green-700 text-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl lg:text-5xl font-bold mb-6">Empowering Communities Through Fresh Food</h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Badge className="bg-orange-500 text-white px-4 py-2 text-lg">Community Driven</Badge>
                <Badge className="bg-white text-green-700 px-4 py-2 text-lg">Locally Sourced</Badge>
                <Badge className="bg-green-500 text-white px-4 py-2 text-lg">Affordable</Badge>
              </div>
            </div>
            <div className="relative flex justify-center">
              <Image
                ...
                width={400}
                height={400}
                className="rounded-lg shadow-2xl object-contain bg-white p-8"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-bold text-green-800 mb-6">What We Do</h3>
